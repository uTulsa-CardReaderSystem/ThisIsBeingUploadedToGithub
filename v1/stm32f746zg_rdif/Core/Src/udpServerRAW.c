...
void udpServer_init(void)
{
   ...
   IP_ADDR4(&myIPADDR, 192,168,68,255);
...
void udp_receive_callback(void *arg, struct udp_pcb *upcb, struct pbuf *p, const ip_addr_t *addr, u16_t port)
{
	...
	char buf[100];
	//char aszHostIp[30]="129.244.42.50";
	   // char aszPort[]="8080";
	//GET volta.ee.utulsa.edu/keymaster/log?door=ieee&id=42561&status=0 HTTP/1.0\r\n\r\n
//
	int len = sprintf (buf,"Hello there");
